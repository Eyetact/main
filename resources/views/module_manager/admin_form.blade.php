            ...
            <div class="card-body pb-2">
                <div class="row">
                    ...
                    <div class="attr_header row flex justify-content-end my-5 align-items-end">
                        <input title="Reset form" class="btn btn-success" id="add_new" type="button" value="+ Add">
                    </div>
                    ...
                    <table class="table table-bordered align-items-center mb-0" id="tbl-field">
                        ...
                        <tbody>
                            <tr draggable="true" containment="tbody" ondragstart="dragStart()" ondragover="dragOver()"
                                style="cursor: move;">
