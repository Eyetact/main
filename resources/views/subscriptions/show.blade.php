        ...
        <div class="border-0">
            <div class="tab-content">
                <div class="tab-pane active" id="myProfile">
                    <div class="card">
                        <form action="{{ route('subscriptions.update',$subscription->id) }}" method="POST" id="editProfile" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="input-box">
                                            ...
                                            <input type="date" class="google-input" name="start_date" id="start_date" value="{{ $subscription->start_date }}"  />
                                        </div>
                                        @error('start_date')
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="input-box">
                                            ...
                                            <input type="text" name="end_date" class="google-input" id="end_date" value="{{ $subscription->end_date }}">
                                        </div>
                                        @error('end_date')
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="input-box">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" id="pending" type="radio" name="status" value="pending">
