    ...
    <div class="page-header">
        <div class="page-leftheader">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="{{url('/' . $page='#')}}">Settings</a></li>
            </ol>
        </div>
    </div>
    <!--End Page header-->
            ...
            <form action="{{ route('setting.store') }}" id="SettingForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class=" card-body">
                        <div class="row">
                            <div class="col-lg-4 col-sm-12">
                                ...
                                <input type="file" class="dropify" name="logo" data-default-file="{{ $data->logo ? asset('uploads/logo/' . $data->logo) : '' }}" data-height="180"  />
                            </div>
                            <div class="col-lg-4 col-sm-12">
                                <label class="form-label">Footer Logo</label>
                                <input type="file" class="dropify" name="footer_logo" data-default-file="{{ $data->footer_logo ? asset('uploads/footer_logo/' . $data->footer_logo) : '' }}" data-height="180"  />
                            </div>
                            <div class="col-lg-4 col-sm-12">
                                <label class="form-label">Web Icon</label>
                                <input type="file" class="dropify" name="web_icon" data-default-file="{{ $data->web_icon ? asset('uploads/web_icon/' . $data->web_icon) : '' }}" data-height="180"  />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 col-md-6">
                                <div class="input-box">
                                    ...
                                    <input type="text" class="google-input" name="copyright_text" id="copyright_text" value="{{($data->copyright_text ?? '')}}"  />
                                </div>
                                @error('copyright_text')
                                <label id="copyright_text-error" class="error" for="copyright_text">{{ $message }}</label>
                                @enderror
                            </div>
                            <div class="col-sm-6 col-md-6">
                                <div class="input-box">
                                    <label class="input-label">Footer Text</label>
                                    <input type="text" name="footer_text" class="google-input" id="footer_text" value="{{($data->footer_text ?? '')}}">
                                </div>
                                @error('footer_text')
                            ...
                            <div class="col-md-6">
                                <div class="input-box">
                                    <textarea class="google-input" id="meta_description" name="meta_description" rows="1" placeholder="Meta Description">{{($data->meta_description ?? '')}}</textarea>
                                </div>
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="input-box">
                                    ...
                                    <input type="text" name="logo_text" id="logo_text" class="google-input" value="{{($data->logo_text ?? '')}}" >
                                </div>
                                @error('logo_text')
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-md-6">
                                <div class="input-box">
                                    ...
                                    <input type="text" class="google-input" name="email" id="email" value="{{ old('email', $data->email) }}"  />
                                </div>
                                @error('email')
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="input-box">
                                    ...
                                    <input type="password" name="password" class="google-input" id="password" value="{{ old('password', $data->password) }}">
                                </div>
                                @error('password')
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="input-box">
                                    ...
                                    <input type="text" name="mail_server" id="mail_server" class="google-input" value="{{ old('mail_server', $data->server) }}" >
                                </div>
                                @error('mail_server')
                                <label id="mail_server-error" class="error" for="mail_server">{{ $message }}</label>
                                @enderror
                            </div>
                            <div class="col-sm-6 col-md-6">
                                <div class="input-box">
                                    <label class="input-label">Port</label>
                                    <input type="tel" name="port" id="port" class="google-input" value="{{ old('port', $data->port) }}" >
                                </div>
                                @error('port')
                            ...
                            <div data-repeater-list="social">
                                @if (isset($socialMediaData) && $socialMediaData->count()>0)
                                    @foreach ($socialMediaData as $socialMedia)
                                        <div data-repeater-item>
                                            ...
                                            <div class="col-sm-1 col-md-1 text-center" style="margin-top: 78px!important;">
                                ...
                                @else
                                    <div data-repeater-item>
                                        <div class="form row">
                                            <div class="col-lg-4 col-sm-4 mt-3">
                                                <input type="file" class="dropify" name="icon" data-default-file="{{ isset($socialMedia) && filled($socialMedia->icon) ? asset('uploads/socialmedia/'.$socialMedia->icon) : '' }}"
                                                       data-height="180"/>
                                            </div>
                                            <div class="col-sm-4 col-md-4 mt-8">
                                                <div class="input-box">
                                                    <label class="input-label">Title</label>
                                                    <input type="text" class="google-input" name="title"
                                                           id="title" value="{{ old('title',isset($socialMedia) && filled($socialMedia->title) ? $socialMedia->title : '') }}"/>
                                                </div>
                                                @error('copyright_text')
                                                <label id="title-error" class="error"
                                                       for="title">{{ $message }}</label>
                ...
                <div class="card">
                    ...
                    <div class=" card-body">
                        <div class="row">
                            <div class="col-sm-6 col-md-6">
                                <div class="input-box">
                                    <label class="input-label">Email</label>
                                    <input type="text" class="google-input" name="contact_email" id="contact_email" value="{{ old('contact_email', $contactSettingData->email) }}"  />
                                </div>
                                @error('contact_email')
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="input-box">
                                    ...
                                    <input type="text" name="contact_phone" id="contact_phone" class="google-input" value="{{ old('contact_phone', $contactSettingData->phone) }}">
                                </div>
                                @error('contact_phone')
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="input-box">
                                    ...
                                    <input type="tel" name="latitude" id="latitude" class="google-input" value="{{ old('latitude', $contactSettingData->latitude) }}" >
                                </div>
                                @error('latitude')
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="input-box">
                                    ...
                                    <input type="tel" name="longitude" id="longitude" class="google-input" value="{{ old('longitude', $contactSettingData->longitude) }}" >
                                </div>
                                @error('longitude')
                    ...
                    <div class="card-footer">
                        ...
                        <button class="btn btn-secondary" type="reset" data-bs-dismiss="modal" aria-label="Close">Cancel</button>
                    </div>
                </div>
            </form>
        </div>
