...
@section('page-header')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">{{ __('Categories') }}</h4>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#"><i class="fe fe-layout mr-2 fs-14"></i>Settings</a></li>
                <li class="breadcrumb-item active" aria-current="page"><a href="#">{{ __('Categories') }}</a></li>
            </ol>
        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table ">
                            <tr>
									...
									<tr>
                                            <td class="fw-bold">{{ __('Slider') }}</td>
                                            <td>{{ $category->slider }}</td>
                                        </tr>
                            <tr>
