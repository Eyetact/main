...
@section('page-header')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">{{ __('Tests') }}</h4>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#"><i class="fe fe-layout mr-2 fs-14"></i>Settings</a></li>
                <li class="breadcrumb-item active" aria-current="page"><a href="#">{{ __('Tests') }}</a></li>
            </ol>
        </div>
     ...
     <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-title">{{ __('Tests') }}</div>
