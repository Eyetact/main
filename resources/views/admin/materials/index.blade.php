    ...
    <script>
        ...
        $(document).on('click', '#edit_item', function() {
            ...
            $.ajax({
                ...
                $(document).on('click', '#add_new_tr_3', function() {
                        let table = $('#tbl-field-3 tbody')
            
                        let no = table.find('tr').length + 1
            
                        let tr = `<tr draggable="true" containment="tbody" ondragstart="dragStart()" ondragover="dragOver()" style="cursor: move;"><td><div class="input-box"> <select name="materials_eu_category[${no}][category]" class="form-select  google-input multi-type" required=""><option value="All Species" >All Species</option><option value="Broiler" >Broiler</option><option value="Layer" >Layer</option><option value="Sheep" >Sheep</option><option value="Cows" >Cows</option></select></div></td> <td>
                                        <div class="input-box">
                                            <input type="text" name="materials_eu_category[${no}][minimum]"
                                     ...
                                     <td>
                                        <div class="input-box">
                                            <input type="text" name="materials_eu_category[${no}][maximum]"
                                                class="form-control google-input"
