        ...
        $(document).on('click', '#edit_item', function() {
            ...
            $.ajax({
                ...
                $(document).on('click', '#add_new_tr_3', function() {
                        ...
                        let tr = `<tr draggable="true" containment="tbody" ondragstart="dragStart()" ondragover="dragOver()" style="cursor: move;"> <td>
                                        <div class="input-box">
                                            <input type="text" name="component[${no}][i_d]"
                                                class="form-control google-input"
                                                placeholder="i_d" required>
                                        </div>
                                    </td>
                                     <td>
                                        <div class="input-box">
                                            <input type="text" name="component[${no}][name]"
                                                class="form-control google-input"
                                     ...
                                     <td>
                                        <div class="input-box">
                                            <input type="date" name="component[${no}][date]"
                                                class="form-control google-input"
