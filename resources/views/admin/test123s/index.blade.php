...
@section('page-header')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">{{ __('Test 123s') }}</h4>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#"><i class="fe fe-layout mr-2 fs-14"></i>Settings</a></li>
                <li class="breadcrumb-item active" aria-current="page"><a href="#">{{ __('Test 123s') }}</a></li>
            </ol>
        </div>
     ...
     <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-title">{{ __('Test 123s') }}</div>
...
@section('js')
    ...
    <script>
        ...
        $(document).on('click', '#add_new', function() {
            ...
            // }, false);
            $.ajax({
                url: "{{ route('test123s.create') }}",
                success: function(response) {
                    //  console.log(response);
                    $(".modal-body").html(response);
                    $(".modal-title").html("Add test123s");
        ...
        $(document).on('click', '#edit_item', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                     ...
                     console.log(response);
                    $(".modal-body").html(response);
                    $(".modal-title").html("edit test123s");
                    $("#role_form_modal").modal('show');
                    $('.dropify').dropify();
                }
            });
