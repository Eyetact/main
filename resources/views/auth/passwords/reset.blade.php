                            ...
                            <div class="card border-grey border-lighten-3 m-0">
                                <div class="card-header border-0">
                                    ...
                                    <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2">
                                        <span>{{ __('Reset Password') }}</span></h6>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="{{ route('password.update') }}" class="form-horizontal form-simple" id="reset_password">
                                            @csrf
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left">
                                                ...
                                                class="form-control @error('password') is-invalid @enderror form-control" name="password" id="user-password" placeholder="{{ __('Password') }}"
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <input id="password_confirmation" type="password" class="form-control @error('password_confirmation') is-invalid @enderror" name="password_confirmation" placeholder="{{ __('Confirm Password') }}" value="{{ old('password_confirmation') }}" autocomplete="password_confirmation" autofocus>
