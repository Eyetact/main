									...
									<div class="d-flex order-lg-2 ml-auto">
										...
										<div class="dropdown profile-dropdown">
											<a href="<?php echo e(url('/' . $page='#')); ?>" class="nav-link pr-0 leading-none" data-toggle="dropdown">
												<span>
													<img src="<?php echo e(URL::asset('assets/images/users/2.jpg')); ?>" alt="img" class="avatar avatar-md brround">
												</span>
											</a>
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
						...
						<!--/app header-->
<?php /**PATH D:\xampp\htdocs\eyt_master\laravel\resources\views/layouts/header.blade.php ENDPATH**/ ?>